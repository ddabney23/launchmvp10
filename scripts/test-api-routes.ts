...
const TEST_CASES: TestCase[] = [
  ...
  { name: 'News GET (public)', path: '/api/news?page=0&pageSize=5', isPublic: true, expectedStatus: [200] },
  {
    name: 'Posts React GET',
    path: '/api/posts/react?postId=00000000-0000-0000-0000-000000000001',
    requiresAuth: true,
    expectedStatus: [401],
  },
  {
    name: 'Posts Share POST',
    path: '/api/posts/share',
    method: 'POST',
    body: { postId: '00000000-0000-0000-0000-000000000001' },
    expectedStatus: [200, 401, 400],
  },
  {
    name: 'Posts View POST',
    path: '/api/posts/view',
    method: 'POST',
    body: { postId: '00000000-0000-0000-0000-000000000001' },
    isPublic: true,
  ...
  {
    name: 'Gamification Redeem GET',
    path: '/api/gamification/redeem',
    requiresAuth: true,
    expectedStatus: [401],
  },
  { name: 'Bookings Create GET', path: '/api/bookings/create', requiresAuth: true, expectedStatus: [401] },
  {
    name: 'Listings Availability GET',
    path: '/api/listings/00000000-0000-0000-0000-000000000001/availability',
    isPublic: true,
